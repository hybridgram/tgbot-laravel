...
- [ ] Удобный инстрмент (скорее всего команда по настроке бота, или в сервис провайдере описание). Установка имени команд и описаний программно на разных языках.
