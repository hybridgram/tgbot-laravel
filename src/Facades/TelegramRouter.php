 ...
 * @method static void onNewChatMembers(array|string|\Closure $action, string $botId = '*')
 * @method static void onLeftChatMember(array|string|\Closure $action, string $botId = '*')
